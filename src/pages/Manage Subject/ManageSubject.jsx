  ...
  return (
    <div className={styles.manage_subject}>
      ...
      <div className={styles.manage_subject__table}>
        ...
        <div>
          <Modal title={null} className="addNew_subject_modal" visible={isModalVisible} onCancel={handleCancel} footer={[<Button className={styles.btn_done}>Done</Button>]}>
            <div className="modal_content">
              ...
              <div className="input_field">
                ...
                <AutoComplete options={options} placeholder="Lecturer Name" bordered={false} filterOption={(inputValue, option) => option.value.toUpperCase().indexOf(inputValue.toUpperCase()) !== -1} />
              </div>
            </div>
          </Modal>
        </div>
