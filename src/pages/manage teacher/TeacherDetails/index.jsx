    ...
    <div className={styles.teacher}>
      <div className={styles.teacher__avatar__form}>
        <img
          ...
          alt=""
          className={styles.teacher__avatar__form__image}
        />
      ...
      <div className={styles.teacher__form__title}>
        ...
        <img
          clasName={styles.teacher__form__title__image}
          src={require("../../../assets/images/divideLine.png")}
        />
      </div>
      <div className={styles.teacher__contact__form}>
        <div className={styles.teacher__contact__form__container}>
          <div className={styles.teacher__contact__form__container__email}>
            ...
            <p
              className={
                styles.teacher__contact__form__container__email__content
              }
            >
          ...
          <div className={styles.teacher__contact__form__container__phone}>
            ...
            <p
              className={
                styles.teacher__contact__form__container__phone__content
              }
            >
              0901121234
            </p>
          ...
          <div className={styles.teacher__contact__form__container__address}>
            ...
            <p
              className={
                styles.teacher__contact__form__container__address__content
              }
            >
              123 Chau Thi Vinh Te
            </p>
          </div>
        </div>
      </div>
      ...
      <div className={styles.teacher__information__form}>
        <div className={styles.teacher__information__form__container}>
          <div className={styles.teacher__information__form__container__item}>
            <div
              className={
                styles.teacher__information__form__container__item__content
              }
            >
              UserID
            </div>
            <div
              className={
                styles.teacher__information__form__container__item__value
              }
            >
              DE140199
            </div>
      ...
      <div className={styles.teacher__form__title}>
        <p className={styles.teacher__form__title__content}>
          Teaching Subjects
        </p>
        <img
          clasName={styles.teacher__form__title__image}
      ...
      <div className={styles.teacher__teaching__subject__form}>
        <div className={styles.teacher__teaching__subject__form__item}>
          SSC102
        </div>
        <div className={styles.teacher__teaching__subject__form__item}>
          SSC102
      ...
      <button className={styles.teacher__button__remove}>
              Remove
      </button>
    </div>
  );
